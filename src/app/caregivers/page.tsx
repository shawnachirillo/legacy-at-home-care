  ...
  return (
    <main className="px-6 py-20">
      <div className="mx-auto max-w-5xl">
        ...
        />
        <div className="mt-12 rounded-soft bg-white p-10">
          <h2 className="font-serif text-3xl font-semibold text-[#4D97E8]">What we look for</h2>
          <ul className="mt-6 space-y-4 font-sans text-[#4D97E8]">
